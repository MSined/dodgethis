...
namespace GCA_Game
{
    ...
    abstract class MenuScreen : GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            texture = content.Load<Texture2D>(@"Sprites/startButton");
        }
            ...
            foreach (GestureSample gesture in input.Gestures)
            {
                if (gesture.GestureType == GestureType.Tap)
                {
                    ...
                    for (int i = 0; i < menuEntries.Count; i++)
                    {
                        ...
                        Rectangle startButton = new Rectangle((int)menuEntry.TexturePos.X, (int)menuEntry.TexturePos.Y, texture.Bounds.Width, texture.Bounds.Height);

                        if (startButton.Contains(tapLocation))
                        {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            for (int i = 0; i < menuEntries.Count; i++)
            {
                ...
                menuEntry.Draw(this, isSelected, gameTime, texture);
            }
